...
for i in range(numMeses):
    for j in range(numAceitesVeg):
        print(addassert(addimplication(addnot(addeq(refinVeg(i,j),"0")),addgt(refinVeg(i,j),T))))
    for j in range(numAceitesNoVeg):
        print(addassert(addimplication(addnot(addeq(refinNoVeg(i,j),"0")),addgt(refinNoVeg(i,j),T))))
